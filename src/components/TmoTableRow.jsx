					  ...
					  <div className="modal-dialog" role="document">
						<div className="modal-content">
						  <div className="modal-header">
							<h5 className="modal-title" id="exampleModalLabel" style={{fontSize: '20px', width: '80%', fontWeight:'500', 'color': 'black'}}>{name}TMO</h5>
							 {/* 
						  ...
						  <div className="modal-body">
							...
							<div style={{ padding: '12px 8px', marginTop: '25px', }}>
								...
								</svg> <span style={{fontSize: '20px'}}>{`${station} / ${detail}`}</span>
							</div>
						    ...
						    <div style={{ padding: '12px 8px' }}>
							   <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clock-fill" viewBox="0 0 16 16">
								...
								</svg> <span style={{fontSize: '20px'}}>평일 : {wtime} / 주말 : {wendtime}</span>
							</div>
